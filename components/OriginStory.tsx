...
const chapters = [
  ...
  },
  {
    ...
    body: "Cut. Trim. Align. This is not the work of an amateur. The individual Arsenal crests, carefully separated from their sheets, await application. Ferrari has Maranello. Lamborghini has Sant'Agata. Arsenal Bottlers™ has this desk. Deal with it.",
  ...
  },
  {
    ...
    body: "History. The first Arsenal Bottlers™ bottle. The Arsenal crest, freshly applied, stares back at you — the logo of a club that finished the UCL with zero titles, now on a bottle of water. The symmetry is poetry.",
  ...
  },
  {
    ...
    body: "Laid flat against a dark surface. The bottle rests, exhausted — much like Arsenal fans watching their team fail to hold possession in extra time. This shot was taken for artistic purposes. And also because sometimes you need to lie down after a 2-0 loss.",
    tag: "00:51 — Flat",
    imageOnRight: false,
  },
  {
  ...
  },
  {
    ...
    body: "Clean background. Full upright. Perfect label alignment. This is the product shot. This is the moment Arsenal Bottlers™ officially becomes a brand. A legacy. A conversation starter that will make at least three Arsenal fans question the friendship.",
    tag: "Final product",
    imageOnRight: false,
  },
];
